...
public class Base64Image {
    public static void main(String[] args) {
        ...
        File saveDir = new File("D:\\apache-tomcat-7.0.70\\wtpwebapps\\h5case\\upload\\1970-01-18");
        saveDir.mkdirs();
        GenerateImage(strImg, "D:\\apache-tomcat-7.0.70\\wtpwebapps\\h5case\\upload\\1970-01-18\\wangyc.jpg");
        
        // 测试从图片文件转换为Base64编码
        System.out.println(GetImageStr("D:\\apache-tomcat-7.0.70\\wtpwebapps\\h5case\\upload\\1970-01-18\\wangyc.jpg"));
    }
