...
import com.pro.xwt.common.exception.ServiceException;
import com.pro.xwt.common.mapper.BaseMapper;
import com.pro.xwt.common.service.BaseService;
...
public class AbstractService<T, ID extends Serializable> implements BaseService<T, ID> {
	...
	public T findByCondition(Map<String, Object> parameter) {
		return baseMapper.findByCondition(parameter);
	}
	...
	public List<T> queryListByPojo(T t) {
		return baseMapper.queryListByPojo(t);
	}
