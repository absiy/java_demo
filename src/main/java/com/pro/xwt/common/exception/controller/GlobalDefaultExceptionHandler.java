package com.pro.xwt.common.exception.controller;
...
import com.pro.xwt.common.exception.AjaxException;
import com.pro.xwt.common.exception.SystemException;
...
public class GlobalDefaultExceptionHandler {
	...
	*/
	...
	public String operateSystemException(SystemException ex, HttpServletRequest request) {
		...
		return Common.VIEW_PATH + "/error/error";
	}
